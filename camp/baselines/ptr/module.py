...
from rl4co.models.zoo.symnco.losses import solution_symmetricity_loss
from rl4co.utils.ops import unbatchify
from rl4co.utils.pylogger import get_pylogger
from torchrl.modules.models import MLP

from camp.models.utils import resample_batch

log = get_pylogger(__name__)


class PtrModule(SymNCO):
    """RL LightningModule for 2D-Ptr based on RL4COLitModule"""
        ...
        **kwargs,
        ...
        if self.use_projection_head:
            if projection_head is None:
                embed_dim = self.policy.embed_dim
                projection_head = (
    ...
    def shared_step(
        ...
        if phase == "train":
            ...
            if self.allow_multi_dataloaders:
                ...
                if dataloader_idx is not None and self.dataloader_names is not None:
                    ...
                    num_agents = int(
                        self.dataloader_names[dataloader_idx].split("_")[-2][1:]
                    )
                else:
        ...
        assert n_start <= 1, "CAMP does not support multi-start"
        ...
        if phase == "train":
            ...
            # No problem invariance loss for 2D-Ptr
            loss_inv = 0
            ...
            loss_ss = solution_symmetricity_loss(reward, ll, dim=1) if n_aug > 1 else 0
