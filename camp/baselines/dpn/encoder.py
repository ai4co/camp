...
from camp.baselines.dpn.env_embeddings import env_init_embedding
from camp.baselines.dpn.nn.attnnet import GraphAttentionNetwork


class DPNEncoder(AutoregressiveEncoder):
    def __init__(
        self,
        embed_dim: int = 128,
