...
class DPNModule(REINFORCE):
    def __init__(
        self,
        env: RL4COEnvBase,
        policy: DPNPolicy = None,
        ...
        **kwargs,
        ...
        if policy is None:
            policy = DPNPolicy(env_name=env.name, **policy_kwargs)

        super(DPNModule, self).__init__(env, policy, baseline, **kwargs)
