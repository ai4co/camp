...
from .decoder import EquityTransformerDecoder
from .encoder import EquityTransformerEncoder
...
class EquityTransformerPolicy(AutoregressivePolicy):
    def __init__(
        ...
        **unused_kwargs,
        ...
        if encoder is None:
            encoder = EquityTransformerEncoder(
                embed_dim=embed_dim,
                num_heads=num_heads,
        ...
        if decoder is None:
            decoder = EquityTransformerDecoder(
                embed_dim=embed_dim,
                num_heads=num_heads,
                env_name=env_name,
