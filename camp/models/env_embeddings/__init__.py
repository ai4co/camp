...
from .pvrp import (
    PVRPInitEmbedding,
    PVRPContextEmbedding,
    PVRPSeqInitEmbedding,
    PVRPSeqContextEmbedding,
)
...
def env_init_embedding(env_name: str, config: dict, registry: dict = None) -> nn.Module:
    ...
    emb_registry = {
        "PVRP_p": PVRPInitEmbedding,
        "PVRP_zc": PVRPInitEmbedding,
        "PVRP_p_seq": PVRPInitEmbedding,
        "PVRP_zc_seq": PVRPInitEmbedding,
    }
...
def env_context_embedding(
    ...
    emb_registry = {
        "PVRP_p": PVRPContextEmbedding,
        "PVRP_zc": PVRPContextEmbedding,
        "PVRP_p_seq": PVRPContextEmbedding,
        "PVRP_zc_seq": PVRPContextEmbedding,
    }
    return env_embedding_register(env_name, config, emb_registry, registry)
...
def env_dynamic_embedding(
    ...
    """
    emb_registry = {
        "PVRP_p": StaticEmbedding,
        "PVRP_zc": StaticEmbedding,
        "PVRP_p_seq": StaticEmbedding,
        "PVRP_zc_seq": StaticEmbedding,
    }
